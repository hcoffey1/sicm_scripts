...
export REF="./fotonik3d_s yee.dat"
export TEST="./fotonik3d_s yee.dat"
export TRAIN="./fotonik3d_s yee.dat"

function 649_fotonik3d_s_prerun {
...
function 649_fotonik3d_s_setup {
  if [[ $SIZE = "ref" ]]; then
    rm -rf run
    cp -r run-ref run
